...
TRANSLATIONS = {
    ...
    # Balloonist dialogue - early hints
    0x2554: ('BEHIND YOU',              '',     '',     12),
    0x2560: ('IS JUST UP THE HILL',     '',     '',     20),
    0x2574: ('THE ENTRANCE PORTAL',     '',     '',     20),
    0x26a4: ('ON WIZARD PEAK.',         '',     '',     16),
    0x26b4: ('WELL TO HUNT FOR EGGS',   '',     '',     24),
    0x26cc: ('I BET YOU WOULD DO',      '',     '',     20),
    0x27c4: ('MAGIC CRAFTERS HOME.',    '',     '',     24),
    0x27dc: ('THIEVES RIGHT HERE IN',   '',     '',     24),
    0x27f4: ('THERE ARE A COUPLE OF',   '',     '',     24),
    0x2918: ('IN CLIFF TOWN.',          '',     '',     16),
    0x2928: ('A THIEF HIDING OUT',      '',     '',     20),
    0x293c: ("I'VE HEARD A RUMOR OF",   '',     '',     24),
    0x2a64: ('IN DRY CANYON.',          '',     '',     16),
    0x2a74: ('ABOUT A PESKY THIEF',     '',     '',     20),
    0x2a88: ('MY FRIEND TOLD ME',       '',     '',     20),
    0x2bc0: ('STONE HILL.',             '',     '',     12),
    0x2bcc: ('RUNNING AROUND IN',       '',     '',     20),
    0x2be0: ('I THINK I SAW A THIEF',   '',     '',     24),
    0x2cec: ('PLACE YOU WILL FIND.',    '',     '',     24),
    0x2d04: ('THE MOST FRIENDLY',       '',     '',     20),
    0x2d18: ("GNASTY'S WORLD IS NOT",   '',     '',     24),
    0x2ddc: ('LIES AHEAD OF YOU.',      '',     '',     20),
    0x2df0: ('I HOPE YOU KNOW WHAT',    '',     '',     24),
    0x2e08: ('WELL DONE, SPYRO!',       '',     '',     20),

    # Balloonist dialogue - early rewards
    0x2f58: ('BUT BEWARE, SPYRO.',      '',     '',     20),
    0x2f6c: ('NICE JOB COLLECTING SO',  '',     '',     24),
    0x30cc: ('6000 STOLEN TREASURES.',  '',     '',     24),
    0x30e4: ('YOU HAVE RECOVERED',      '',     '',     20),
    0x30f8: ('COME SEE ME AGAIN WHEN',  '',     '',     24),
    0x325c: ('GET ALL THE GOOD JOBS.',  '',     '',     24),
    0x3274: ('BALLOONS. THE FAIRIES',   '',     '',     24),
    0x328c: ("I'M TIRED OF RENTING",    '',     '',     24),

    # Balloonist dialogue - dragon rescue
    0x33a8: ('DREAM WEAVERS WORLD.',    '',     '',     24),
    0x33c0: ("AND I'LL SHOW YOU THE",   '',     '',     24),
    0x33d8: ('JUMP IN THE BALLOON',     '',     '',     20),
    0x3524: ('TO PATCH THAT LEAK.',     '',     '',     20),
    0x3538: ('I BARELY HAD A CHANCE',   '',     '',     24),
    0x3550: ('WOW, THAT WAS QUICK!',    '',     '',     24),
    0x368c: ('HAVE BEEN RESCUED.',      '',     '',     20),
    0x36a0: ('THAT SO MANY DRAGONS',    '',     '',     24),
    0x36b8: ('I FEEL MUCH BETTER NOW',  '',     '',     24),
    0x37cc: ('BETTER AT NIGHT.',        '',     '',     20),
    0x37e0: ("I'LL BE ABLE TO SLEEP",   '',     '',     24),
    0x37f8: ('RESCUE 50 DRAGONS SO',    '',     '',     24),
    0x3938: ('FEEL A LITTLE BETTER.',   '',     '',     24),
    0x3950: ("50 DRAGONS THEN I'LL",    '',     '',     24),
    0x3968: ('MAYBE ONCE YOU RESCUE',   '',     '',     24),
    0x3aa8: ('TRAPPED IN CRYSTAL.',     '',     '',     20),
    0x3abc: ('OF THE DRAGONS STILL',    '',     '',     24),
    0x3ad4: ('I FEEL SORRY FOR ALL',    '',     '',     24),
    0x3b70: ('BEAST MAKERS WORLD',      '',     '',     20),

    # Balloonist dialogue - late game
    0x3c74: ('THAN YOU LOOK.',          '',     '',     16),
    0x3c84: ('YOU MUST BE FASTER',      '',     '',     20),
    0x3c98: ('GREAT WORK SPYRO!',       '',     '',     20),
    0x3d9c: ('OUR DRAGON EGGS.',        '',     '',     20),
    0x3db0: ('RECOVERING SO MANY OF',   '',     '',     24),
    0x3dc8: ('THANK YOU, SPYRO, FOR',   '',     '',     24),
    0x3ef0: ('THOSE 5 DRAGON EGGS.',    '',     '',     24),
    0x3f08: ('CAN HELP YOU RECOVER',    '',     '',     24),
    0x3f20: ('HEY SPYRO, MAYBE I',      '',     '',     20),
    0x403c: ('FROM THEM, WOULD YOU?',   '',     '',     24),
    0x4054: ('RECOVER 5 DRAGON EGGS',   '',     '',     24),
    0x406c: ('DO ME A FAVOR AND',       '',     '',     20),
    0x4168: ('OVER THE PLACE.',         '',     '',     16),
    0x4178: ('ARE HIDING OUT ALL',      '',     '',     20),
    0x418c: ('THOSE SNEAKY THIEVES',    '',     '',     24),
    0x42a8: ('IF YOU ARE READY.',       '',     '',     20),
    0x42bc: ('MAGIC CRAFTERS WORLD',    '',     '',     24),
    0x42d4: ('HOP ABOARD FOR THE',      '',     '',     20),
    0x43fc: ('BECOME A REAL DRAGON.',   '',     '',     24),
    0x4414: ('ONE DAY YOU MIGHT',       '',     '',     20),
    0x4428: ('NICE JOB SPYRO!',         '',     '',     16),
    0x4560: ('MUCH STOLEN TREASURE.',   '',     '',     24),
    0x4578: ('FAST YOU FOUND SO',       '',     '',     20),
    0x458c: ("I CAN'T BELIEVE HOW",     '',     '',     20),
    0x46a8: ('1200 STOLEN TREASURES.',  '',     '',     24),
    0x46c0: ('FOR YOU TO FIND',         '',     '',     16),
    0x46d0: ("I'M STILL WAITING",       '',     '',     20),
    0x47f0: ("I'LL SHOW IT TO YOU.",    '',     '',     24),
    0x4808: ('1200 STOLEN TREASURES',   '',     '',     24),
    0x4820: ('MAYBE IF YOU FIND',       '',     '',     20),
    0x4940: ('AND VERY DANGEROUS.',     '',     '',     20),
    0x4954: ('WORLD IS FAR AWAY',       '',     '',     20),
    0x4968: ('THE MAGIC CRAFTERS',      '',     '',     20),
    0x4d00: ('DRAGONS, SPYRO.',         '',     '',     16),
    0x4d10: ('BEEN BUSY RESCUING',      '',     '',     20),
    0x4d24: ('WOW!  I SEE YOU HAVE',    '',     '',     24),
